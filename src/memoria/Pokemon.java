...
public final class Pokemon {
    ...
    public Pokemon(
        ...
        if (nombre == null || nombre.isBlank()
                || nivel < 1 || nivel > 100
                || tipo == null || hpMaximo < 1
                || normal == null || fuerte == null || especial == null
                || normal.efecto() != Estado.Efecto.NINGUNO
                || fuerte.efecto() != Estado.Efecto.NINGUNO
                || normal.dano() <= 0
                || fuerte.dano() <= normal.dano()
                || especial.efecto() == Estado.Efecto.NINGUNO) {
    ...
    int curar(int cantidad) {
        ...
        int real = Math.min(hpMaximo - hp, cantidad);
        hp += real;
        return real;
    }
